...
{
    public class TestNodeView : FlowNodeView
    {
        public override Type nodeType => typeof(TestNode);
        ...
        public TestNodeView(FlowGraphView graphView, FlowNode node) : base(graphView, node)
        {
